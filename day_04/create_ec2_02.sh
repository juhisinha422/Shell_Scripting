...
#--------------------------------------------------------
# Go to IAM -> create user (shell -admin) -> attach policies (ec2-full access) -> create user
# create access key and secret key
# run command : aws configure and paste secret key and access key and region : ap-south-1
# give instance AMI_ID, Key_name, subnet id give from ec2 (networking) or vpc, copy any security group id (in create_ec2.sh file)
